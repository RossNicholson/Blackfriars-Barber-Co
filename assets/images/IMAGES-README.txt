Blackfriars Barber Co. – Required photos (PNG only) + dimensions
================================================================

Save all images as PNG and use these exact filenames in the folder: assets/images/
Dimensions are in pixels (width × height). Use at least the minimum; 2× is for sharp retina displays.

--------------------------------------------------------------------------------
HOME
--------------------------------------------------------------------------------

hero-exterior-barbershop.png
  Dimensions: 1920 × 1080 px (minimum). For retina: 2400 × 1350 px.
...
--------------------------------------------------------------------------------
  Display size: 300 × 300 px. Supply at 600 × 600 px for retina; minimum 300 × 300 px.

team-alex-reid-lead-barber.png          600 × 600 px
  → Headshot or portrait of Alex Reid (lead barber). Square or croppable to square.

team-jamie-okonkwo-senior-barber.png    600 × 600 px
  → Headshot or portrait of Jamie Okonkwo (senior barber). Square or croppable to square.

team-ryan-moss-barber.png               600 × 600 px
...
og-image.png                            1200 × 630 px (exact)
  → Dedicated social preview (Open Graph / Twitter). If you add this, update og:image and twitter:image in each page’s <head> to use it instead of the hero.
